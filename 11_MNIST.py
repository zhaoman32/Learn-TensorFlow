...
After 0 training step(s), validation accuracy using average model is 0.0718 
...
After 9000 training step(s), validation accuracy using average model is 0.9848 
After 10000 training step(s), validation accuracy using average model is 0.9846 
After 11000 training step(s), validation accuracy using average model is 0.9846 
After 12000 training step(s), validation accuracy using average model is 0.9852 
...
After 28000 training step(s), validation accuracy using average model is 0.9856 
After 29000 training step(s), validation accuracy using average model is 0.985 
After 30000 training step(s), test accuracy using average model is 0.9844
